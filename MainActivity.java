...
public class MainActivity extends AppCompatActivity implements RecInterface {
    ...
    int[] contactImages = {R.drawable.b_guy, R.drawable.w_guy2, R.drawable.w_woman,
            R.drawable.w_guy, R.drawable.old_w_guy, R.drawable.w_beard_guy, R.drawable.old_w_guy, R.drawable.b_guy};
